...
#terms.container.grid-md
  ...
  p When you register with us and use the Application, you generally provide (a) your name, email address, user name, and other registration information; (b) transaction-related information, such as when you use any application functionality; (c) information you provide us when you contact us for help and; (e) information you enter into our system when using the Application.
  ...
  h5 Automatically Collected Information
  ...
  h5 Does the Application collect precise real time location information of the device?
  p This Application does not collect precise information about the location of your mobile device.

  h5 Do third parties see and/or have access to information obtained by the Application?
  p Only aggregated, anonymized data is periodically transmitted to external services to help us improve the Application and our service. We will share your information with third parties only in the ways that are described in this privacy statement.
  ...
  ul
    ...
    li if Developer Company Name is involved in a merger, acquisition, or sale of all or a portion of its assets, you will be notified via email and/or a prominent notice on our Web site of any change in ownership or uses of this information, as well as any choices you may have regarding this information.

  h5 What are my opt-out rights?
  p You can stop all collection of information by the Application easily by uninstalling the Application. You may use the standard uninstall processes as may be available as part of your mobile device or via the mobile application marketplace or network. You can also request to opt-out via email, at usb@cs.purdue.edu

  h4 Data Retention Policy, Managing Your Information
  ...
  h4 Contact us
  p If you have any questions regarding privacy while using the Application, or have questions about our practices, please contact us via email at usb@cs.purdue.edu.
</template>
