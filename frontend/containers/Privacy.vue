...
#terms.container.grid-lg
  h4 OpenIdeas Privacy Policy
  p This privacy policy governs your use of the software application OpenIdeas for web devices that was created by&nbsp;Purdue Computer Science Undergraduate Student Board.&nbsp;</p>
  ...
  p When you register with us and use the Application, you generally provide&nbsp;(a) your name, email address, user name, and other registration information; (b) transaction-related information, such as when you use any application functionality; (c) information you provide us when you contact us for help and; (e) information you enter into our system when using the Application.</p>
  ...
  h6 Automatically Collected Information
  ...
  <h5><strong>Data Retention Policy, Managing Your Information</strong></h5>
  ...
  <h5>Contact us</h5>
  p If you have any questions regarding privacy while using the Application, or have questions about our practices, please contact us via email at&nbsp;usb@cs.purdue.edu</p>
</template>
